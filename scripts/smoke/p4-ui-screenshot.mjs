 ...
 * Saves: tmp/smoke-evidence/P4_2_UI/widgets.png
 *
 * Requires: auth state from auth-login-save-state.mjs (no addCookies).
 * Env: PROOF_STORAGE_STATE (default: tmp/smoke-evidence/auth/auth-state.json),
...
const OUT_DIR = path.join(process.cwd(), 'tmp', 'smoke-evidence', 'P4_2_UI');
