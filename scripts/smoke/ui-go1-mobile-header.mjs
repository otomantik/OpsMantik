 ...
 * - Screenshot to tmp/smoke-evidence/PHASE4_GO1
 */
...
const outDir = path.join(root, 'tmp', 'smoke-evidence', 'PHASE4_GO1');

const targetUrl =
  process.env.PROOF_URL ||
  'https://console.opsmantik.com/dashboard/site/00000000-0000-4000-8000-000000000001';
