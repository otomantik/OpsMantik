 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/oci-muratcan-gclid-bridge.mjs
 *          node scripts/db/_archive/site-specific/oci-muratcan-gclid-bridge.mjs --dry-run
 */
