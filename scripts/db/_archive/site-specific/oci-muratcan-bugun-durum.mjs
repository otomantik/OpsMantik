 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/oci-muratcan-bugun-durum.mjs
 *           node scripts/db/_archive/site-specific/oci-muratcan-bugun-durum.mjs muratcanaku.com
 */
