 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/oci-muratcan-demir-muhur-tek-satis.mjs
 *           node scripts/db/_archive/site-specific/oci-muratcan-demir-muhur-tek-satis.mjs --dry-run
 */
