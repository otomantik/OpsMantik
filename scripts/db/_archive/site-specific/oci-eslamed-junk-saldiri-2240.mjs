 ...
 *
 * Kullanım:
 *   node scripts/db/_archive/site-specific/oci-eslamed-junk-saldiri-2240.mjs           # dry-run (sadece listele)
 *   node scripts/db/_archive/site-specific/oci-eslamed-junk-saldiri-2240.mjs --apply   # gerçekten junk'la
 */
...
async function main() {
  ...
  if (!doApply) {
    ...
    console.log('');
    console.log('  Gerçekten çöpe atmak için: node scripts/db/_archive/site-specific/oci-eslamed-junk-saldiri-2240.mjs --apply');
    console.log('');
    return;
  }
