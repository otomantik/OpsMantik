 ...
 *
 * Kullanım:
 *   node scripts/db/_archive/site-specific/oci-eslamed-2240-rontgen-saldiri-ayikla.mjs
 *   node scripts/db/_archive/site-specific/oci-eslamed-2240-rontgen-saldiri-ayikla.mjs --full
 *
 * Muratcan için:
