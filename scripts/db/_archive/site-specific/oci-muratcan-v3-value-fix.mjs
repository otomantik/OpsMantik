 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/oci-muratcan-v3-value-fix.mjs
 *           node scripts/db/_archive/site-specific/oci-muratcan-v3-value-fix.mjs --dry-run
 */
