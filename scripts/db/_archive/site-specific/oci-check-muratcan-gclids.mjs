 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/oci-check-muratcan-gclids.mjs
 */
...
async function run() {
  ...
  if (failedWithFormat.length > 0) {
    ...
    if (withBoth.length > 0) {
      ...
      console.log('  Sadece gclid göndermek için: node scripts/db/_archive/site-specific/oci-muratcan-only-gclid.mjs');
    }
