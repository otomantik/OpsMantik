 ...
 *
 * Kullanım: node scripts/db/_archive/site-specific/eslamed-intent-event-deep-analiz.mjs [--start ISO] [--end ISO]
...
async function run() {
  ...
  console.log('  Tekrar çalıştır: docs/runbooks/_archive/site-specific/oci_eslamed_dun_11_12_intent_analiz.sql');
}
