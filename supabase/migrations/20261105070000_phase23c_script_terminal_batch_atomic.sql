...
COMMENT ON FUNCTION public.append_script_transition_batch(uuid[], text, timestamptz, jsonb) IS
  'Phase 23C generic script-owned batch append/apply path for terminal or retry transitions. Caller provides a shared error_payload JSONB including clear_fields metadata.';
