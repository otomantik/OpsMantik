-- HunterCard Data Correctness v1: expose device_os from sessions in get_recent_intents_v2.
-- Depends on 20260130250800_sessions_device_os (column on sessions).
...
IS 'Live Inbox RPC: intents + device_os for HunterCard Data Correctness v1.';
