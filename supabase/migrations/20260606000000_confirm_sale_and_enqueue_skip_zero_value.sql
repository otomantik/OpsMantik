-- PR-OCI-4 (P0): Defense-in-depth — do not enqueue 0/NULL sales.
-- confirm_sale_and_enqueue must NEVER create offline_conversion_queue rows with value_cents <= 0.
BEGIN;
...
BEGIN
  ...
  -- P0: 0 TL never reaches Google. Confirm sale but DO NOT enqueue.
