-- =============================================================================
-- Fix: get_recent_intents_v2 "cannot pass more than 100 arguments" (54023)
--
-- Root cause: jsonb_build_object() was extended beyond 50 key/value pairs
-- (=> >100 args). Postgres errors at runtime, breaking Hunter queue.
--
-- Solution: build a single record and convert via to_jsonb(record), which has
-- no variadic-arg limit and keeps the same response shape.
-- =============================================================================
...
-- Keep explicit grants (safe if already present)
