-- Migration: Executive Analytics v1 - Revenue Projection + Pulse Stats
-- Date: 2026-01-31
--
-- Adds:
-- - projected_revenue to get_command_center_p0_stats_v1
...
GRANT EXECUTE ON FUNCTION public.get_command_center_p0_stats_v2(uuid, timestamptz, timestamptz, boolean) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_command_center_p0_stats_v2(uuid, timestamptz, timestamptz, boolean) TO service_role;
