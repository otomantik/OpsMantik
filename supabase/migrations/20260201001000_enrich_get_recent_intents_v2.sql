-- Migration: Enrich get_recent_intents_v2 with session intel
-- Date: 2026-02-01
--
-- Adds missing session fields (UTMs, Device, Matchtype) to the RPC result.
-- This ensures HunterCard has all data needed for INTEL and TARGET boxes.
