-- HunterCard v3: expose utm_source, utm_medium, utm_campaign, utm_content from sessions in get_recent_intents_v2.
-- Depends on 20260130250300_sessions_utm_source_medium_campaign_content (columns on sessions).
...
IS 'Live Inbox RPC: intents + full UTM intel for HunterCard v3.';
