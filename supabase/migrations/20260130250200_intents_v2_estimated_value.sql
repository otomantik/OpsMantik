-- HunterCard v3 CASINO CHIP: expose estimated_value and currency from calls in get_recent_intents_v2.
...
IS 'Live Inbox RPC: intents + intel + estimated_value/currency for HunterCard v3 CASINO CHIP.';
