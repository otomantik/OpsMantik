-- Decrement usage compensation RPC
-- Decrements revenue_events_count or conversion_sends_count by 1 (floor 0) when processSyncEvent fails.
-- Service_role only. Used by /api/workers/ingest on processSyncEvent throw.
-- Original 20260226120000 ran before usage_counters/_jwt_role existed; this ensures correct order.
-- =============================================================================
