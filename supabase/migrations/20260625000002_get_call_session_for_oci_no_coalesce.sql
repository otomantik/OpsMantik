-- =============================================================================
-- Precision Logic: get_call_session_for_oci COALESCE kaldırma (partition pruning)
-- Önkoşul: 20260625000000 trigger + backfill ile session_created_month zorunlu
-- Return type must match 20260603000000 (conversion_time_formatted).
-- =============================================================================
...
COMMENT ON FUNCTION public.get_call_session_for_oci(uuid, uuid) IS
  'OCI: partition pruning via session_created_month. No COALESCE. conversion_time_formatted included.';
