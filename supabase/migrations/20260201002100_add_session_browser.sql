-- Migration: Add browser to sessions and enrich get_recent_intents_v2
-- Date: 2026-02-01
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'sessions' AND COLUMN_NAME = 'browser') THEN
        ALTER TABLE public.sessions ADD COLUMN browser text;
    END IF;
END $$;

-- Update get_recent_intents_v2 to return telco_carrier AND browser
