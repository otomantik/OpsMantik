-- HunterCard v3: expose ads_network, ads_placement from sessions in get_recent_intents_v2.
-- Depends on 20260130250500_sessions_ads_network_placement (columns on sessions).
...
IS 'Live Inbox RPC: intents + full UTM + ads_network/ads_placement for HunterCard v3.';
