...
/**
 * Today's work / CRM desk removed from product surface; old links go to Intent command center.
 */
export default async function TodayDeskRedirect({ params }: PageProps) {
