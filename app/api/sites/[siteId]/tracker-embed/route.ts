...
export async function GET(
  ...
  try {
    ...
    const proxyScriptTag = `<script defer src="${CONSOLE_ORIGIN}/assets/core.js?v=7" data-ops-site-id="${sitePublicId}" data-ops-consent="analytics" data-api="${CONSOLE_ORIGIN}/api/sync"${proxyUrl ? ` data-ops-proxy-url="${proxyUrl}"` : ''}></script>`;
    const signedScriptTag = `<script defer src="${CONSOLE_ORIGIN}/assets/core.js?v=7" data-ops-site-id="${sitePublicId}" data-ops-secret="${secret}" data-ops-consent="analytics" data-api="${CONSOLE_ORIGIN}/api/sync"></script>`;
