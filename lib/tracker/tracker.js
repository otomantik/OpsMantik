...
import { getHardwareMeta, makeIntentStamp, generateUUID, getAdsContext } from './utils';
...
// GDPR / Consent - Default to analytics if no CMP detected
let trackerConsentScopes = ['analytics'];
