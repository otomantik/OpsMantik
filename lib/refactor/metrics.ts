...
export const REFACTOR_METRIC_NAMES = [
  ...
  'source_truth_shadow_eval_total',
  'source_truth_shadow_drift_paid_total',
  'source_truth_shadow_drift_channel_total',
  ...
  'panel_stage_outbox_skip_merged_call_total',
  'panel_stage_outbox_skip_no_exportable_oci_stage_total',
