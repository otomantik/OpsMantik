...
| `20261103000000_bitemporal_offline_conversion_queue` | Bitemporal valid_from/valid_to | Rollback: `trg_offline_conversion_queue_bitemporal` disable; app must tolerate NULL valid_from/valid_to. |
