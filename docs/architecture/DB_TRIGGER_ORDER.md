...
- Bitemporal `marketing_signals` triggers/history were **dropped** (see `20260419170000_drop_bitemporal_marketing_signals.sql`); do not resurrect in docs or runtime assumptions.
