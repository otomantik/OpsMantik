        ...
        <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card className="border-l-4 border-l-amber-500 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                        Highest phone/WA activity detected.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                        Engagement time for paid traffic.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-emerald-500 bg-emerald-50/30 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                    <div className="text-xs font-semibold text-emerald-800 leading-relaxed">
                        💡 Suggestion: Enable <span className="underline">Sticky Call Button</span> at {peakHourStr} for max CRO.
                    </div>
                    <div className="mt-2 text-[10px] text-emerald-600 font-medium">
                        Based on {metrics.total_calls} recent intent events.
                    </div>
                </CardContent>
            </Card>
        </div>
