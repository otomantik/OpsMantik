      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <code className="block px-2 py-1 bg-background border border-border rounded text-foreground text-sm leading-relaxed break-all">
            {`<script defer src="https://assets.yourdomain.com/assets/core.js?v=4" data-ops-site-id="test_site_123" data-ops-consent="analytics" data-api="https://console.yourdomain.com/api/sync"></script>`}
          </code>
