...
export function SitesManager() {
  ...
  const copySnippet = async () => {
    ...
    const snippet = `<script defer src="https://assets.${domain}/assets/core.js?v=7" data-ops-site-id="${newSite.public_id}" data-ops-consent="analytics" data-api="${apiUrl}"></script>`;
            ...
            <div>
              ...
              <div className="flex gap-2">
                <code className="flex-1 px-3 py-2 bg-background border border-border rounded text-foreground text-sm break-all">
                  {`<script defer src="https://assets.${getPrimaryDomain()}/assets/core.js?v=7" data-ops-site-id="${newSite.public_id}" data-ops-consent="analytics" data-api="https://console.${getPrimaryDomain()}/api/sync"></script>`}
                </code>
                <Button
                  onClick={copySnippet}
                  size="sm"
                ...
                <div className="pt-2 border-t border-border">
                  ...
                  <div className="mt-3 pt-3 border-t border-border">
                    ...
                    <code className="block px-2 py-1 bg-muted/40 border border-border rounded text-foreground text-sm break-all">
                      {fullEmbedBySite[site.id] || `<script defer src="https://assets.${getPrimaryDomain()}/assets/core.js?v=7" data-ops-site-id="${site.public_id}" data-ops-consent="analytics" data-api="https://console.${getPrimaryDomain()}/api/sync"></script>`}
                    </code>
